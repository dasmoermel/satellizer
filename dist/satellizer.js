...
var AuthProvider = (function () {
    ...
    Object.defineProperty(AuthProvider.prototype, "logoutUrl", {
        get: function () { return this.SatellizerConfig.logoutUrl; },
        set: function (value) { this.SatellizerConfig.logoutUrl = value; },
        enumerable: true,
        configurable: true
    });
    ...
    AuthProvider.prototype.$get = function (SatellizerShared, SatellizerLocal, SatellizerOAuth) {
        return {
            ...
            logout: function (data, options) { return SatellizerLocal.logout(data, options); },
...
var Local = (function () {
     ...
     */
    Local.prototype.logout = function (data, options) {
        var _this = this;
        if (options === void 0) { options = {}; }
